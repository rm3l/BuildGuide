...
This guide will walk you through the steps to set up an android 8.1 build enviorment on ubuntu 16.04 as well as the build proccess for any Lineage-OS supported Device.
