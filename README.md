...
This guide will walk you through the steps to set up the android 8.1 build enviorment on ubuntu 16.04 as well as on how to modify device tree to be compatible with your ROMs source :)
